      ...
      >
        {certifications.map((cert) => (
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-300">{cert.organization}</p>
            <a
              href={cert.link}
              target="_blank"
              rel="noreferrer"
              className="mt-5 inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-sm text-white backdrop-blur-xl transition-all duration-300 ease-in-out hover:scale-105"
            >
              View Certificate
